...
def random_trips(net_file: str, output_file: str, end_time: int = 3600, period: float = 1.0, options: list = None) -> str:
    """
...
def duarouter(net_file: str, route_files: str, output_file: str, options: list = None) -> str:
    """
